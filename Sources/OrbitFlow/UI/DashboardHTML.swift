...
enum DashboardHTML {
    static func render(runs: [DictationRun], compareMode: Bool = false, key: String = "Right \u{2325}") -> String {
        ...
        <title>Orbit Flow — engine comparison</title>
        <style>
        :root{--bg:#f6f6f4;--panel:#fff;--ink:#15171b;--muted:#5f646c;--line:#e3e3df;
              --accent:#c9342b;--warn:#a87a1e;--good:#2f8259;}
        @media (prefers-color-scheme:dark){:root{--bg:#101216;--panel:#171a20;--ink:#e9ebef;
              --muted:#98a0ac;--line:#262b33;--accent:#e04338;--warn:#d9a441;--good:#4fa87a;}}
        :root[data-theme="dark"]{--bg:#101216;--panel:#171a20;--ink:#e9ebef;--muted:#98a0ac;--line:#262b33;--accent:#e04338;--warn:#d9a441;--good:#4fa87a;}
        :root[data-theme="light"]{--bg:#f6f6f4;--panel:#fff;--ink:#15171b;--muted:#5f646c;--line:#e3e3df;--accent:#c9342b;--warn:#a87a1e;--good:#2f8259;}
        *{box-sizing:border-box}
        ...
        h1{margin:0 0 4px;font-size:27px;letter-spacing:-.02em;font-weight:600;
        ...
        <div class="bar">
          ...
          \(runs.isEmpty ? "" : "<a class=\"btn\" href=\"orbitflowyt://clear\">Clear results</a>")
        </div>
        \(body)
        <footer>
